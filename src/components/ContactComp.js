    ...
    <>
      <div className="text-center w-full py-20 bg-white">
        ...
        <div className="flex bg-indigo-900 justify-center gap-x-10 py-14 mx-20">
          <div
            data-aos="flip-left"
            className="h-96 w-1/3 ml-10 border-white border-solid border bg-indigo-900 flex items-center"
          >
            <div className="ml-7">
              <img src={Maps} alt="" />
            </div>
          ...
          <div
            data-aos="flip-left"
            className="h-96 w-1/3 border-white border-solid border bg-indigo-900 flex items-center"
          >
            <div data-aos="fade-right" className="ml-7">
              <img src={Telephone} alt="" />
            </div>
            <div data-aos="fade-right" className="text-left ml-5">
          ...
          <div
            data-aos="flip-left"
            className="h-96 w-1/3 mr-10 border-white border-solid border bg-indigo-900 flex items-center"
          >
            <div data-aos="fade-right" className="ml-7">
              <img src={Email} alt="" />
            </div>
